...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(1440, 900, "framework", NULL, NULL);
	if (window == NULL) {
		glfwTerminate();
		return -2;
	}
	...
	GLuint shader = LoadShaders("shaders/vertexShader.ver", "shaders/fragmentShader.frag");
	GLuint VAO, VBO, EBO;
	...
	do {
		...
		glClearColor(0.6f, 0.09f, 0.59f, 1.0f);
